    ...
    <footer className="relative py-12 lg:py-16 bg-gradient-soft border-t border-rose-200/50 dark:border-primary/20 overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 pointer-events-none z-0 isolate overflow-hidden">
        ...
        <img 
          ...
          className="absolute bottom-0 left-0 w-32 md:w-48 lg:w-56 opacity-60 dark:opacity-40 mix-blend-multiply dark:invert transform-gpu will-change-transform [backface-visibility:hidden]"
        />
        ...
        <img 
          src={flowerArt} 
          alt="Flower Corner"
          className="absolute bottom-0 right-0 w-32 md:w-48 lg:w-56 opacity-60 dark:opacity-40 mix-blend-multiply dark:invert scale-x-[-1] transform-gpu will-change-transform [backface-visibility:hidden]"
        />
